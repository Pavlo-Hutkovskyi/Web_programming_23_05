...
function addbegin2(str,num) {
    if (num == 2) {
        document.getElementById(str).innerHTML = "A( <input type='number' id='a'> , <input type='number' id='a'> , <input type='number' id='a'> )";
    } else {
        document.getElementById(str).innerHTML = name + "=( " + "<input type='number' id='a'>,<input type='number' id='a'>,<input type='number' id='a'>" + " )";
    }
}
...
function l_to_line() {
    let tre=document.getElementsByTagName('input')[3].value*1;
    ...
    var l=Math.abs(poch+ser+tre)/Math.sqrt(Math.pow(document.getElementsByTagName('input')[0].value,2)+Math.pow(document.getElementsByTagName('input')[1].value,2)+Math.pow(document.getElementsByTagName('input')[2].value,2));
